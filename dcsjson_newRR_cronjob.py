...
#activate_this = "/afs/cern.ch/work/a/amkalsi/private/work/runregistry/venv/bin/activate_this.py"
#execfile(activate_this, dict(__file__=activate_this))
import os
import sys
import subprocess

#__args = ["scl", "enable", "rh-python36", "bash"]

#out = subprocess.Popen(__args, stdout=subprocess.PIPE)

#print out.communicate()[0]
              
activator = "/afs/cern.ch/work/a/amkalsi/private/work/runregistry/venv/bin/activate_this.py"
#execfile(activate_this, dict(__file__=activate_this))
...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--outfile",
        dest="outfile", type=str, default="json_out_2017.txt", help="Output file name")
    ...
    parser.add_argument("-min", "--min_run", dest="min_run", type=int, default=268000, help="minimum run for json")
